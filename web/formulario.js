    ...
    if (formulario === 'login') {
        document.getElementById('formulario').innerHTML = `
            ...
            <form class='formulario' action="" method="post">
                    ...
                    <input id='input' type="email" id="email" name="email" required>
                    </div>
                    <div class='div'>
                    <label class='label' for="contrasena">Contraseña:</label>
                    <input id='input' type="password" id="contrasena" name="contrasena" required>
                    </div>
                    <div class='div'>
        ...
        document.getElementById('formulario').innerHTML = `
            ...
            <form class = 'formulario2' action="" method="post">
                    ...
                    <div class='div'>
                        ...
                        <input id='input' type="text" id="apellido" name="apellido" required>
                    </div>

                    <div class='div'>
                        <label class='label' for="email_registro">Email:</label>
                        <input id='input' type="email" id="email_registro" name="email_registro" required>
                    </div>

                    <div class='div'>
                        <label class='label' for="contrasena_registro">Contraseña:</label>
                        <input id='input' type="password" id="contrasena_registro" name="contrasena_registro" required>
                    </div>

                    <div class='div'>
                        <label class='label' for="direccion">Dirección:</label>
                        <input id='input' type="text" id="direccion" name="direccion" required>
                    </div>

                    <div class='div'>
                        <label class='label' for="telefono">Teléfono:</label>
                        <input id='input' type="tel" id="telefono" name="telefono" required>
                    </div>
